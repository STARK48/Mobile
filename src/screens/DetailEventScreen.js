  ...
  const event = route.params;
    return(
      ...
      >
        ...
        <ImageBackground style={{flex:0.7}} source={event.eventImage}>
        ...
        <View style={styles.detailsConaitiner}>
          ...
          <View style={{flexDirection:'row',marginTop:10}}>
            ...
            <Text style={{color:COLORS.primary,fontSize:20,fontWeight:'bold',marginLeft:5}}>{event.location}</Text>
          </View>
          <View style={{flexDirection:'row',marginTop:10}}>
            <Icon name="md-calendar-outline" size={25} color={COLORS.primary}></Icon>
            <Text style={{color:COLORS.primary,fontSize:20,fontWeight:'bold',marginLeft:5}}>{event.dateBegin}</Text>
          </View>
          <Text style={{marginTop:20,fontWeight:'bold',fontSize:20}}>About the event</Text>
          <Text style={{marginTop:20,lineHeight:22}}>{event.description}</Text>
        </View>
      </SafeAreaView>
    );
  };
